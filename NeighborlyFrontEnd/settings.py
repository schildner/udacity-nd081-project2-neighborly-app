#--------- Flask settings
SERVER_HOST = 'https://neighborlyfrontend-es81.azurewebsites.net' # Update this for the appropriate front-end website when up
...
API_URL = " https://neighborlyapp-es81.azurewebsites.net/api"
