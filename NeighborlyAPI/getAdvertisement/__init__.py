...
def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    logging.info('Python HTTP trigger function getAdvertisement processing a request.')
    ...
    if id:
        try:
            ...
            return func.HttpResponse(document, mimetype="application/json", charset='utf-8')
